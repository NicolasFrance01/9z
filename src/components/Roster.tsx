    ...
    const divisionsData: GameDivision[] = [
        {
            ...
            coverBg: 'linear-gradient(135deg, rgba(255, 122, 0, 0.15) 0%, rgba(139, 45, 251, 0.3) 100%)',
            icon: 'fa-gun',
        ...
        },
        {
            ...
            title: 'VALORANT',
            genre: 'Hero Shooter',
            coverBg: 'linear-gradient(135deg, rgba(0, 240, 255, 0.15) 0%, rgba(255, 0, 122, 0.25) 100%)',
            icon: 'fa-bullseye',
        ...
        },
        {
            ...
            coverBg: 'linear-gradient(135deg, rgba(0, 240, 255, 0.2) 0%, rgba(9, 5, 20, 0.8) 100%)',
            icon: 'fa-car-side',
        ...
        },
        {
            ...
            title: 'PUBG Mobile',
            genre: 'Battle Royale',
            coverBg: 'linear-gradient(135deg, rgba(0, 255, 136, 0.15) 0%, rgba(26, 9, 51, 0.4) 100%)',
        ...
        },
        {
            ...
            genre: 'MOBA',
            coverBg: 'linear-gradient(135deg, rgba(255, 184, 0, 0.15) 0%, rgba(139, 45, 251, 0.3) 100%)',
        ...
        },
        {
            ...
            genre: 'MOBA',
            coverBg: 'linear-gradient(135deg, rgba(139, 45, 251, 0.2) 0%, rgba(255, 0, 122, 0.15) 100%)',
        ...
        },
        {
            ...
            genre: 'Tactical Shooter',
            coverBg: 'linear-gradient(135deg, rgba(0, 168, 255, 0.15) 0%, rgba(9, 5, 20, 0.9) 100%)',
        ...
        },
        {
            ...
            title: 'Creadores & IRL',
            genre: 'Streamers',
            coverBg: 'linear-gradient(135deg, rgba(255, 0, 122, 0.15) 0%, rgba(139, 45, 251, 0.3) 100%)',
            icon: 'fa-comments',
