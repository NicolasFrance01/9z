    ...
    const divisionsData: GameDivision[] = [
        {
            ...
            coverBg: 'url(/src/assets/covers/cs2.png) center/cover',
            icon: 'fa-gun',
        ...
        },
        {
            ...
            title: 'VALORANT',
            genre: 'Hero Shooter',
            coverBg: 'url(/src/assets/covers/valorant.png) center/cover',
            icon: 'fa-bullseye',
        ...
        },
        {
            ...
            coverBg: 'url(/src/assets/covers/simracing.png) center/cover',
            icon: 'fa-car-side',
        ...
        },
        {
            ...
            title: 'PUBG Mobile',
            genre: 'Battle Royale',
            coverBg: 'url(/src/assets/covers/pubg_mobile.png) center/cover',
        ...
        },
        {
            ...
            genre: 'MOBA',
            coverBg: 'url(/src/assets/covers/honor_of_kings.png) center/cover',
        ...
        },
        {
            ...
            genre: 'MOBA',
            coverBg: 'url(/src/assets/covers/mobile_legends.png) center/cover',
        ...
        },
        {
            ...
            genre: 'Tactical Shooter',
            coverBg: 'url(/src/assets/covers/rainbow_six.png) center/cover',
        ...
        },
        {
            ...
            title: 'Creadores & IRL',
            genre: 'Streamers',
            coverBg: 'url(/src/assets/covers/creadores.png) center/cover',
            icon: 'fa-comments',
